        ...
        <div className="flex-1 flex">
            ...
            <div className="w-80 p-6 space-y-6">
                <SidebarCard
                    ...
                    description="Create divisions and departments to organize your company structure effectively."
                    items={["Examples: HR, Finance, IT, Marketing, Operations"]}
                    variant="primary"
                />
                ...
                <SidebarCard
                    ...
                    description=""
                    items={[
                        "Start with main departments first",
                        "Add sub-divisions for larger departments",
