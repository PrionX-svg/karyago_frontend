      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <Input
            ...
            className="w-4 h-4 text-orange-500 border-gray-300 dark:border-stone-800 rounded focus:ring-orange-500"
          />
          <Label
            htmlFor="remember"
            className="text-sm text-gray-600 dark:text-stone-300"
          >
