...
import { Save, User, Mail, Phone, Calendar, Lock, Users, UserCheck, Briefcase, CheckCircle } from "lucide-react"
...
export default function AddUserManually() {
    ...
    const [employeeHistoryData, setEmployeeHistoryData] = useState<EmployeeHistoryFormData>({
        employee_uuid: "",
        company_uuid: "",
        position: "",
        is_present: true,
    ...
    const { createEmployeeHistory, isCreatingEmployeeHistory } = employee.useCreateEmployeeHistory()
    ...
    const handleEmployeeHistoryChange = (field: keyof EmployeeHistoryFormData, value: string | boolean) => {
    ...
    const validateForm = (): boolean => {
        ...
        } else if (employeeHistoryData.end_date && new Date(employeeHistoryData.end_date) < new Date(employeeHistoryData.start_date)) {
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-8">
                                            ...
                                            <motion.div className="space-y-6" variants={itemVariants}>
                                                <div className="flex items-center space-x-3 mb-6">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <h3 className="text-xl font-semibold text-gray-900">{ae('firstFormTitle')}</h3>
                                                        ...
                                                        <div className="flex items-center space-x-3">
                                                            <Switch
                                                                ...
                                                                onCheckedChange={(checked) => {
                                                                    handleEmployeeHistoryChange("is_present", checked as boolean)
                                                                    if (checked) {
                                            ...
                                            <motion.div className="space-y-6" variants={itemVariants}>
                                                <div className="flex items-center space-x-3 mb-6">
                                                    ...
                                                    <h3 className="text-xl font-semibold text-gray-900">{ae('secondFormTitle')}</h3>
                                                </div>
                                                    ...
                                                    <div className="grid md:grid-cols-2 gap-6">
                                                        <motion.div variants={itemVariants} className="space-y-2">
                                                            ...
                                                            <Input
                                                                ...
                                                                onChange={(e) => handleEmployeeHistoryChange("position", e.target.value)}
                                                                placeholder="Senior Backend Developer"
                                                                className={`h-12 border-2 transition-all duration-200 focus:ring-2 focus:ring-orange-500/20 ${errors.position ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-gray-300"
                                                                    }`}
                                                            />
                                                            {errors.position && (
                                                                <motion.p
                                                        ...
                                                        <motion.div variants={itemVariants} className="space-y-2">
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                <Input
                                                                    id="start_date"
                                                                    type="date"
                                                                    value={employeeHistoryData.start_date ? new Date(employeeHistoryData.start_date).toISOString().split("T")[0] : ""}
                                                                    onChange={(e) => {
                                                                        const dateValue = e.target.value ? new Date(e.target.value).toISOString() : ""
                                                                        handleEmployeeHistoryChange("start_date", dateValue)
                                                                    }}
                                                                    className={`h-12 pl-12 border-2 transition-all duration-200 focus:ring-2 focus:ring-orange-500/20 ${errors.start_date ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-gray-300"
                                                                        }`}
                                                                />
                                                            </div>
                                                            {errors.start_date && (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="relative">
                                                                ...
                                                                <Input
                                                                    id="end_date"
                                                                    type="date"
                                                                    value={employeeHistoryData.end_date ? new Date(employeeHistoryData.end_date).toISOString().split("T")[0] : ""}
                                                                    onChange={(e) => {
                                                                        const dateValue = e.target.value ? new Date(e.target.value).toISOString() : ""
                                                                        handleEmployeeHistoryChange("end_date", dateValue)
                                                                    }}
                                                                    className={`h-12 pl-12 border-2 transition-all duration-200 focus:ring-2 focus:ring-orange-500/20 ${errors.end_date ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-gray-300"
                                                                        }`}
                                                                />
                                                            </div>
                                                            {errors.end_date && (
                                            ...
                                            <motion.div className="space-y-6" variants={itemVariants}>
                                                <div className="flex items-center space-x-3 mb-6">
                                                    ...
                                                    <h3 className="text-xl font-semibold text-gray-900">{ae('thirdFormTitle')}</h3>
                                                </div>
                                                <motion.div variants={itemVariants} className="space-y-2">
