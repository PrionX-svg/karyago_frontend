...
export default function EmployeePage() {
    ...
    useEffect(() => {
        ...
        decryptUuid().catch((error) => console.error("Failed to decrypt UUID:", error))
    }, [])
    ...
    return (
        <div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6 p-4 bg-white dark:bg-neutral-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex bg-gray-100 dark:bg-neutral-800 rounded-lg p-1">
                            ...
                            >
                                <List
                                    className={`w-4 h-4 ${viewType === "table" ? "text-white" : "text-gray-500 dark:text-gray-400"}`}
                                />
                            </Button>
                            <Button
                            ...
                            >
                                <LayoutGrid
                                    className={`w-4 h-4 ${viewType === "card" ? "text-white" : "text-gray-500 dark:text-gray-400"}`}
                                />
                            </Button>
                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-2 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-neutral-800 dark:to-neutral-900 rounded-lg border border-gray-200 dark:border-gray-700">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-neutral-400 dark:text-neutral-300">
                                                {employee.phone || (
                                                    <span className="italic text-neutral-400 dark:text-neutral-500">No phone</span>
                                                )}
                                            </span>
                                        </div>
                                        <div className="flex items-center gap-2">
            ...
            <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>Upload an Excel file to import multiple employees at once</DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                            <div>
                                <h4 className="font-semibold text-gray-900 dark:text-gray-100">Download Template</h4>
                        ...
                        >
                            {file ? (
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{file.name}</p>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            {(file.size / (1024 * 1024)).toLocaleString(undefined, { maximumFractionDigits: 2 })} MB
                                        </p>
                                    </div>
                                    <Button variant="ghost" size="sm" onClick={resetFile} className="text-gray-500 hover:text-gray-700">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">Drop your Excel file here</p>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Supports .xlsx and .xls files</p>
                                    </div>
                                    <div>
                                        <input
                                            ref={fileInputRef}
            ...
            <Dialog open={showImportedDataDialog} onOpenChange={setShowImportedDataDialog}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2">
                        ...
                        <DialogDescription>The following employees have been successfully imported</DialogDescription>
                    </DialogHeader>
                                ...
                                importedData.map((employee, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {employee.phone && <p className="text-sm text-gray-500 dark:text-gray-500">{employee.phone}</p>}
                                        </div>
                                    </div>
                                ))
                            ) : (
                                <p className="text-center text-gray-500 dark:text-gray-400">No import data available</p>
                            )}
                        </div>
                    </ScrollArea>
